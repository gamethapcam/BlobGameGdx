...
import com.stan.game.Screens.GameOverScreen;
 ...
 */
public class GameOverScreenInputListener implements InputProcessor {

    public GameOverScreen screen;

    public GameOverScreenInputListener(GameOverScreen screen){
        this.screen = screen;
    }
